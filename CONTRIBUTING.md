...
In the CI, tests are run on multiple Python versions (from 3.10 to 3.14)
...
- [tests](.github/workflows/tests.yml): runs unittests on multiple Python versions (from 3.10 to 3.14)
